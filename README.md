...
### 🛠 Software Engineer | Java Specialist | Modernization Lead

Passionate about transforming legacy monoliths into scalable microservices. I bridge the gap between complex backend architecture and seamless developer experiences. When I'm not orchestrating containers, I'm usually weaving dark narratives as a Tabletop RPG Game Master.
...
### 🎲 Beyond the Code
* **Game Mastering:** Currently running a long-term horror-western campaign.
* **VTT Innovation:** Building a high-performance Virtual Tabletop platform to improve dynamic character management.
